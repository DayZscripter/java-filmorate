...
public class FilmDbStorage extends DbStorage implements FilmStorage {
    final Logger log = LoggerFactory.getLogger(FilmDbStorage.class);
    final RatingMpaStorage ratingMpaStorage;
    ...
    public Film findFilmById(int id) {
        ...
        if (sqlRowSet.next()) {
            ...
            throw new ObjectNotFoundException(String.format("фильм с таким id %d не найден", id));
        }
    }
    ...
    //установкой жанра фильму занимается FilmService.
    @Override
